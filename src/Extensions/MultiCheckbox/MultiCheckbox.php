...
namespace Wenruns\Form\Extensions\MultiCheckbox;
...
class MultiCheckbox extends Field
{
     ...
     * @var string
     */
    protected $view = 'admin.form.multicheckbox';
    ...
    {
        $this->checkJs()->checkViewFile()->checkCss();
    ...
    {
        $path = __DIR__ . '/multiCheckbox.css';
        $dirPath = public_path('wenruns/css');
        $filePath = $dirPath . '/multiCheckbox.css';
    ...
    {
        $path = __DIR__ . '/multiCheckbox.js';
        $dirPath = public_path('wenruns/js');
        $filePath = $dirPath . '/multiCheckbox.js';
        if (!is_file($filePath) || filemtime($path) > filemtime($filePath)) {
            if (!is_dir($dirPath)) {
                mkdir($dirPath, 0777, true);
            }
    ...
    protected function checkViewFile()
    {
        ...
        $viewPath = $viewDir . '/multicheckbox.blade.php';
        $originPath = __DIR__ . '/multicheckbox.blade.php';
