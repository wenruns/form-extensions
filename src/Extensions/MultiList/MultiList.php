...
class MultiList extends Field
{
     ...
     * @var string
     */
    protected $view = 'admin.form.multilist';
    ...
    protected function checkViewFile()
    {
        ...
        $viewPath = $dirPath . '/multilist.blade.php';
        $filePath = __DIR__ . '/multilist.blade.php';
        if (!is_file($viewPath) || filemtime($filePath) > filemtime($viewPath)) {
            if (!is_dir($dirPath)) {
                mkdir($dirPath, 0777, true);
            }
            file_put_contents($viewPath, file_get_contents($filePath));
        }
        return $this;
    }
...
HTML;
    ...
    protected function checkTableListClosure($key = 0)
    {
        ...
        $this->tableListClosure && $this->tableListClosure->call($this, $this->getTableList(true)->value($this->value, $key));
        return $this;
    }
