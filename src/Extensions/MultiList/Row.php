...
class Row extends BaseColumn
{
    ...
    public function __construct(MultiList $multiList, $column, $label, $type = 'text', $parentColumn = null, $displayCallback = null, Field $field = null)
    {
        parent::__construct($multiList, $column, $label, $type, $parentColumn, $displayCallback);
        $this->field = $field;
    ...
    {
        $column = new Column($this->multiList, $this->column, $this->label, $this->type, $this->parentColumn, $this->displayCallback);
